...
if __name__ == '__main__':
    ...
    print(Z.shape)
    print(Q.shape)
    save_data(Z,'mrnd_opt_par_spring_3_1_2',folder='NL_opt')
    save_data(Q,'mrnd_opt_cst_spring_3_1_2',folder='NL_opt')
    save_data(M,'mrnd_opt_code_spring_3_1_2',folder='NL_opt')
    meta_data=[B1,soc_lim,soc_softc,'rp_50gb_qs_qf_spring',C,Cdev,w]
    print(meta_data)
    save_data(meta_data,'mrnd_opt_metadata_spring_3_1_2',folder='NL_opt')